                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="form-label-group">
                                <input type="email" id="inputEmail" class="form-control" name="email" placeholder="Ingresar email" value="<?php echo e(old('email')); ?>" required>
                            ...
                            <button class="btn btn-lg btn-primary btn-block" type="submit"><?php echo e(__('Iniciar sesión')); ?></button>
                            <a class="d-block text-center mt-2 small" href="register"><?php echo e(__('¿No tienes una cuenta? Regístrate.')); ?></a>
                        </form>
                    </div>
                </div>
            </div>
